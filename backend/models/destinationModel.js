...
const DestinationSchema = new Schema(
  {
    name: {
      ...
      maxlength: [
        40,
        "Destinations name has to be less then 40 characters",
      ],
      minlength: [
        4,
        "Destinations name has to be less then 4 characters",
      ],
      validate: {
        validator: (val) =>
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message:
          "Discount Price ({VALUE}) cannot be greater then regular price",
      },
    },
    durationInDays: {
      type: Number,
