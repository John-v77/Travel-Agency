...
import Adventure from "./components/Pages/ParallaxPage/Adventure";
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 overflow-hidden relative">
      ...
      <Routes>
        ...
        <Route path="details/:productId" element={<DestinationDetails />} />
        <Route path="account" element={userToken ? <Account /> : <Login />} />
        <Route path="register" element={<Register />} />
        <Route path="/cart" element={<ShoppingCartPage />} />
        <Route path="parallax" element={<Adventure />} />
      </Routes>
      <Footer />
    </div>
  );
